...
// Copyright (c) 2011-2013 grumpycoin Developers.
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        if (fTestNet)
        {
            block.nTime    = 1388702434;             //test net not supported
            block.nNonce   = 0;
        }
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // grumpycoin: increase each by adding 2 to bitcoin's value.
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // grumpycoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
